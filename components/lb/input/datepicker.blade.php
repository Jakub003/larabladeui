...
datePickerCalculateDays();">
    ...
    <div class="relative w-full group">
        <input x-ref="datePickerInput" type="text" @click="datePickerOpen=!datePickerOpen" x-model="datePickerValue"
            ...
            class="border border-neutral-200 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm h-10 placeholder:text-neutral-500 disabled:cursor-not-allowed disabled:opacity-50 text-sm w-full"
            placeholder="Select date" readonly />
        <div @click="datePickerOpen=!datePickerOpen; if(datePickerOpen){ $refs.datePickerInput.focus() }"
            class="absolute top-0 right-0 px-3 py-2 cursor-pointer text-neutral-500 hover:text-primary-500">
            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
        </div>
        <div style="display:none" x-show="datePickerOpen" x-transition @click.away="datePickerOpen = false"
